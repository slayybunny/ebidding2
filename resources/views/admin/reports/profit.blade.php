    ...
    <div class="container">
        <div class="report-card">
            <div class="report-header">
                <h1 class="report-title">Laporan Keuntungan Bulanan</h1>
                <p class="report-subtitle">Analisa Prestasi Kewangan Syarikat</p>
            </div>
                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="chart-card landscape-chart">
                            <h4 class="chart-title">Trend Keuntungan & Komisen Bulanan</h4>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="chart-card small-chart">
                            <h4 class="chart-title">Jumlah Lelongan</h4>
                            <div class="chart-wrapper">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="chart-card small-chart">
                            <h4 class="chart-title">Prestasi Bulanan</h4>
                            <div class="chart-wrapper">
                ...
                <table class="corporate-table table">
                    <thead>
                        <tr>
                            <th>Bulan</th>
                            <th>Tahun</th>
                            <th>Jumlah Lelongan Tamat</th>
                            <th>Jumlah Keuntungan (RM)</th>
                            <th>Komisen Admin (RM)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="month-cell">Julai</td>
            ...
            <div class="summary-footer">
                <div class="summary-stats">
                    <div class="stat-item">
                        ...
                        <div class="stat-label">Total Lelongan</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value">RM 3,350.00</div>
                        <div class="stat-label">Jumlah Keuntungan</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value">RM 167.50</div>
                        <div class="stat-label">Total Komisen</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value">RM 670.00</div>
                        <div class="stat-label">Purata Bulanan</div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    // Data untuk graf
    const monthlyData = {
        labels: ['Mac', 'April', 'Mei', 'Jun', 'Julai'],
        profits: [380, 920, 700, 500, 850],
        commissions: [19, 46, 35, 25, 42.5],
        auctions: [2, 6, 4, 3, 5]
    };

    // Graf Keuntungan Bulanan (Landscape)
    ...
    // Graf Doughnut untuk Jumlah Lelongan
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(context) {
                            ...
                            return context.label + ': ' + context.parsed + ' lelongan (' + percentage + '%)';
                        }
                    }
                }
            },
    ...
    // Animation untuk numbers counting up
    ...
    // Graf Bar untuk Prestasi Bulanan
    ...
    const performanceChart = new Chart(performanceCtx, {
        ...
        data: {
            labels: monthlyData.labels,
            datasets: [{
                label: 'Purata Keuntungan per Lelongan',
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(context) {
                            return 'RM ' + context.parsed.y + ' per lelongan';
                        }
                    }
                }
            },
    ...
    // Jalankan animasi selepas page load
