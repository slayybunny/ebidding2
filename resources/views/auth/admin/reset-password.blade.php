...
<head>
    ...
    <title>Set Semula Kata Laluan - No One Is Left Behind</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* Anda boleh menggunakan CSS yang sama dari fail login atau forgot-password */
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="form-section">
            <div class="form-container">
                <div class="header">
                    ...
                    <p class="subtitle">Sila masukkan kata laluan baru anda.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.password.update') }}">
                    ...
                    <div class="form-group">
                        <input type="email" name="email" id="email" value="{{ old('email', $email) }}" required placeholder="Email Address">
                    ...
                    <div class="form-group">
                        <input type="password" name="password" id="password" required placeholder="New Password" autofocus>
